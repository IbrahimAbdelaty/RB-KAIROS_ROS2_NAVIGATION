...
def generate_launch_description():
    ...
    turtlebot3_cartographer_prefix = get_package_share_directory('mapping')
    ...
    return LaunchDescription([
        ...
        Node(
            ...
            remappings=[ # <--- Here's the remapping
                ('/scan_1', '/robot/front_laser/scan'), #lase scan topic
                ('/scan_2', '/robot/rear_laser/scan'),
                ('/odom', '/robot/robotnik_base_controller/odom'),
                ('/imu', '/robot/imu/data')
            ]),   
                    #   '/scan' , '/robot/front_laser/scan']),
                    #   'scan_1' , '/robot/rear_laser/scan',]),
